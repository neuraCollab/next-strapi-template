    ...
    >
      <div className="">
        {article.image ? (
          ...
          <div className="h-full flex items-center justify-center group-hover:bg-neutral-900">{/* <Logo /> */}</div>
        )}
      </div>
        ...
        <div>
          <div className="flex gap-4 flex-wrap mb-4">
            {article.categories?.map((category, idx) => (
              <p key={`category-${idx}`} className="text-xs font-bold text-muted px-4 py-2 rounded-full bg-neutral-800 capitalize">
                {category.name}
              </p>
            ))}
          </div>
    ...
    >
      <div className="">
        {article.image ? (
          ...
          <div className=" h-64 md:h-96 flex items-center justify-center group-hover:bg-neutral-900">{/* <Logo /> */}</div>
        )}
      </div>
      <div className="p-4 md:p-8 group-hover:bg-neutral-900 flex flex-col justify-between">
        <div>
