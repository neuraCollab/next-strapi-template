...
export const FeatureIconContainer = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <div className=" [perspective:400px] [transform-style:preserve-3d]">
      <div
        className={cn("h-14 w-14 p-[4px] rounded-md bg-gradient-to-b from-neutral-800  to-neutral-950 mx-auto relative")}
        style={{
          transform: "rotateX(25deg)",
          transformOrigin: "center",
        }}
      >
        <div className={cn("bg-charcoal rounded-[5px] h-full w-full relative z-20", className)}>{children}</div>
