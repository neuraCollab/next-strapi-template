  ...
  return (
    ...
    >
      ...
      >
        ...
        <Cursor className="top-40 left-0 group-hover:left-40 group-hover:top-20" textClassName="group-hover:text-secondary" />
      </div>
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="2" height="265" viewBox="0 0 2 265" fill="none">
        <path d="M1 265V1" stroke={`url(#${id})`} strokeOpacity="0.1" strokeWidth="1.5" strokeLinecap="round" />
        <defs>
