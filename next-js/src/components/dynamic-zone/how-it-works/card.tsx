...
import { motion, useMotionValue, useMotionTemplate, useScroll, useTransform, useMotionValueEvent, useSpring } from "framer-motion"
import { CanvasRevealEffect } from "../../ui/canvas-reveal-effect"
import Beam from "../../beam"

export const Card = ({ title, description, index }: { title: string; description: string; index: number }) => {
