...
export const Featured = ({ products, locale }: { products: Product[]; locale: string }) => {
  ...
  return (
    <div className="py-20">
      ...
      <p className="text-neutral-500 text-lg mt-4 mb-10">Pick from our most popular collection</p>
...
const FeaturedItem = ({ product, locale }: { product: Product; locale: string }) => {
  ...
  return (
    <Link
      ...
      className="group border border-neutral-800 rounded-md overflow-hidden relative block bg-neutral-900 aspect-square"
    >
