...
const mockData = [
  { id: 1, title: "Домой", url: "/" },
  { id: 2, title: "Авторизация", url: "/auth/signin" },
  { id: 3, title: "Личный  кабинет", url: "/user-dashboard" },
  { id: 4, title: "Блог", url: "/blog" },
  { id: 5, title: "Домашняя страница", url: "/homepage" },
  { id: 6, title: "ЧАО", url: "/faq" },
  { id: 7, title: "Продукты", url: "/products" },
]
