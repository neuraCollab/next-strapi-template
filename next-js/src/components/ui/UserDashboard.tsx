...
export default function UserDashboard() {
  ...
  return (
    <div className="relative bg-[#f7f6f9] h-full min-h-screen font-sans flex">
      {/* Sidebar */}
      <nav
        className={`bg-white shadow-lg h-screen fixed top-0 left-0 overflow-auto z-50 transition-all duration-500 
        ...
        <header className="z-50 bg-[#f7f6f9] sticky top-0 pt-8 px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center bg-white shadow-sm px-6 py-2 rounded-md w-full max-w-md">
              <input type="text" placeholder="Search something..." className="w-full text-sm bg-transparent outline-none" />
            </div>
