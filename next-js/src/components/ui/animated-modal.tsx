...
export const ModalTrigger = ({ children, className, onClick }: { children: ReactNode; className?: string; onClick?: () => void }) => {
...
export const ModalFooter = ({ children, className }: { children: ReactNode; className?: string }) => {
  return <div className={cn("flex justify-end p-4 bg-gray-100 ", className)}>{children}</div>
}
