    ...
    >
      ...
      <div className="w-full ">
        ...
        >
          ...
          <motion.p className="text-lg text-neutral-500 font-regular max-w-sm mt-2">{item.description}</motion.p>
        </motion.div>
      </div>
    </motion.div>
  )
...
export const ScrollContentMobile = ({
  ...
  return (
    ...
    >
      <motion.div key={item.title + index} className="w-full rounded-md  self-start mb-8">
        {item.content && item.content}
      </motion.div>
      <div className="w-full">
        <motion.div className=" mb-6">
          ...
          <motion.p className="text-sm md:text-base text-neutral-500 font-bold max-w-sm mt-2">{item.description}</motion.p>
        </motion.div>
      </div>
    </motion.div>
  )
