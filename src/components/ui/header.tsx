...
const Header = () => (
  <header className="relative w-full h-screen">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center text-white">
      ...
      {/* Buttons */}
      <div>
        <a href="#services" className="bg-blue-500 text-white px-6 py-3 rounded-full text-lg mr-4">
          Our Services
        </a>
        <a href="#contact" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-full text-lg">
          Contact Us
        </a>
      </div>
    </div>
