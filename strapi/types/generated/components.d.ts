...
export interface DynamicZoneComponentsHeaderLeftBlocks extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_components_header_left_blocks"
  info: {
    description: ""
    displayName: "header_left_blocks"
  }
  attributes: {
...
export interface DynamicZoneComponentsHeaderPhoneButtonOptions extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_components_header_phone_button_options"
  info: {
    description: ""
    displayName: "header_phone_button_options"
  }
  attributes: {
...
export interface DynamicZoneComponentsHeaderPhoneForms extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_components_header_phone_forms"
  info: {
    description: ""
    displayName: "header_phone_forms"
  }
  attributes: {
    phone_button_option: Schema.Attribute.Component<"dynamic-zone.components-header-phone-button-options", true>
    placeholder: Schema.Attribute.String
  }
}

export interface DynamicZoneComponentsHeaderRightBlocks extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_components_header_right_blocks"
  info: {
    description: ""
    displayName: "header_right_blocks"
  }
  attributes: {
    phone_form: Schema.Attribute.Component<"dynamic-zone.components-header-phone-forms", false>
    title: Schema.Attribute.String
  }
}
...
export interface DynamicZoneHeader extends Struct.ComponentSchema {
  ...
  attributes: {
    backgroundVideo: Schema.Attribute.Media<"images" | "files" | "videos"> & Schema.Attribute.Required
    button: Schema.Attribute.Component<"shared.button", true>
    header_left_block: Schema.Attribute.Component<"dynamic-zone.components-header-left-blocks", false>
    header_right_block: Schema.Attribute.Component<"dynamic-zone.components-header-right-blocks", false>
  }
}
...
export interface DynamicZoneSmallCarts extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_small_carts"
  info: {
    displayName: "small-carts"
    icon: "bulletList"
  }
  attributes: {
    heading: Schema.Attribute.String
...
export interface DynamicZoneVideos extends Struct.ComponentSchema {
  collectionName: "components_dynamic_zone_videos"
  info: {
    displayName: "Videos"
    icon: "music"
  }
  attributes: {
    Heaing: Schema.Attribute.String
    videos: Schema.Attribute.Media<"images" | "files" | "videos" | "audios", true>
  }
}
...
export interface SharedButton extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    text: Schema.Attribute.String
    URL: Schema.Attribute.String
    variant: Schema.Attribute.Enumeration<["simple", "outline", "primary", "muted"]> & Schema.Attribute.DefaultTo<"primary">
  }
}
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ComponentSchemas {
      ...
      "dynamic-zone.components-header-left-blocks": DynamicZoneComponentsHeaderLeftBlocks
      "dynamic-zone.components-header-phone-button-options": DynamicZoneComponentsHeaderPhoneButtonOptions
      "dynamic-zone.components-header-phone-forms": DynamicZoneComponentsHeaderPhoneForms
      "dynamic-zone.components-header-right-blocks": DynamicZoneComponentsHeaderRightBlocks
      ...
      "dynamic-zone.small-carts": DynamicZoneSmallCarts
      "dynamic-zone.testimonials": DynamicZoneTestimonials
      "dynamic-zone.videos": DynamicZoneVideos
