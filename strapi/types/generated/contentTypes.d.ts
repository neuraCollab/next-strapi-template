...
export interface ApiFaqSlideFaqSlide extends Struct.CollectionTypeSchema {
  collectionName: "faq_slides"
  info: {
    description: ""
    displayName: "FAQ slides"
    pluralName: "faq-slides"
    singularName: "faq-slide"
  }
  options: {
    draftAndPublish: true
  }
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<"oneToMany", "api::faq-slide.faq-slide">
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
  }
